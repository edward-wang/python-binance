"""COIN-M Futures Trade API endpoints."""
...
async def create_order(
    ...
    raw = await http.request_raw("POST", "/dapi/v1/order", signed=True, params=params)
...
async def create_test_order(
    ...
    return await http.request("POST", "/dapi/v1/order/test", signed=True, params=params)
...
async def get_order(
    ...
    raw = await http.request_raw("GET", "/dapi/v1/order", signed=True, params=params)
    return _order_decoder.decode(raw)
...
async def cancel_order(
    ...
    raw = await http.request_raw("DELETE", "/dapi/v1/order", signed=True, params=params)
    return _order_decoder.decode(raw)
...
async def cancel_all_open_orders(
    ...
    """
    params: dict[str, Any] = {"symbol": symbol}
    return await http.request("DELETE", "/dapi/v1/allOpenOrders", signed=True, params=params)
...
async def get_open_orders(
    ...
    raw = await http.request_raw("GET", "/dapi/v1/openOrders", signed=True, params=params)
...
async def get_all_orders(
    ...
    raw = await http.request_raw("GET", "/dapi/v1/allOrders", signed=True, params=params)
    return _order_list_decoder.decode(raw)
...
async def create_batch_orders(
    ...
    Args:
        orders: List of order dicts (max 5). Each dict should contain:
            ...
            - quantity: Order quantity in contracts (required for most types)
            - price: Limit price (required for LIMIT orders)
    ...
    Example:
        orders = [
            {"symbol": "BTCUSD_PERP", "side": "BUY", "type": "LIMIT",
             "quantity": "1", "price": "30000", "timeInForce": "GTC"},
            {"symbol": "BTCUSD_PERP", "side": "SELL", "type": "LIMIT",
             "quantity": "1", "price": "35000", "timeInForce": "GTC"},
        ]
    ...
    raw = await http.request("POST", "/dapi/v1/batchOrders", signed=True, params=params)
